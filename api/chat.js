...
function buildSystemPrompt(memberName, memberNick, searchResults) {
  ...
  lines.push("== শব্দার্থ ==");
  lines.push("");
  lines.push("== বিরাটি ঠেক বিখ্যাত উক্তি (attribution ভুল করলে চলবে না) ==");
  lines.push("Manoj/Jhatu: 'ছিঃ!' | 'রাষ্ট্রের হিতে জীবন সমর্পণ' | 'আমি অনেক দূর যেতে চাই, যেখানে আকাশ নীল—' (কবিতা)");
  lines.push("Sandip/বাঁকা: 'BKCD!' | 'Toke tag korini, ektu chup korbi' | 'বুলবুলি পাখি এসে তোর মাথায় ঠোঁট দিয়ে বিলি কেটে দেবে' | 'ফাইনালি মুনা এসে তোর বিচি টিপে ঘুম ভাঙ্গলো'");
  lines.push("Raju/Chotichata Muna: 'Dhur baal!' | 'Rokkhar kor, bhikker dorkar nei kukur samlao' | 'O Bou tumi agrohi hole ami raji'");
  lines.push("Biplab/Bagh: 'Commission koto nicchyish??' | 'বো চো' | 'চোখ বন্ধ করে কীর্তন শুনুন, চোখ খুললেই Sugar বেড়ে যাবে'");
  lines.push("Arindam/জটায়ু: 'Mayabi.. modhur..' | 'Kichhu bolar nei' | 'Puro gajakhor AI' | 'Beshi bhaajiye golmal ta korli'");
  lines.push("Manik/দার্শনিক টোকাই: 'সব মায়া। 🙏' | 'শ্রীরাম-এর চরণে সেবা লাগি' | 'টেরো কার্ড অনুযায়ী' | 'বোকাচোদা, আমার একটাই দল ঈশ্বরের চরণে সেবা করা' | 'অপশব্দ বলা বারণ'");
  lines.push("Avijit/চুল/জামাই: 'তাও ঠিক।' | 'Free te hole ne, label dekhar dorkar nei' | 'Dhop maris na'");
  lines.push("Debanjan/বউ: 'sara prithibi te Muna-r doorsamporker Atmiyo ra choRiye aachey' | 'without any অহংকার' | 'Muna r sambhabona beshi due to Sighropaton'");
  lines.push("Shantu/কুত্তু: 'Ki korbi eto taka niye'");
  lines.push("Ayan/লেখক: 'আজ ঠেক জমে গেছে! চলুক!' | 'টান টান উত্তেজনা!' | 'জাস্ট ভাবা যায় না!'");
  lines.push("Bubai: 'Babara ready hoea jao line die khawanor jonno'");
  lines.push("Jhatu Sandip-কে: 'ঠোঁট দিয়ে বুলবুলি বিলি কেটে দেবে — এটা শতাব্দীর সেরা উক্তি'");
